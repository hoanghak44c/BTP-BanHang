...
{
    public class XuatKhoDataProvider : BusinessProviderBase, IBussinessKhoProvider<ChungTuBanHangInfor, ChungTuBanHangChiTietInfor, ChungTuBanHangChiTietHangHoaInfor>
    {
        private static XuatKhoDataProvider instance;
        public static XuatKhoDataProvider Instance
        {
            get
            {
                if (instance == null) instance = new XuatKhoDataProvider();
                return instance;
            }
        }
        #region chungtu
