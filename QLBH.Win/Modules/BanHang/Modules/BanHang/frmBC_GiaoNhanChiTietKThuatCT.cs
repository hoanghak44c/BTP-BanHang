...
{
    public partial class frmBC_GiaoNhanChiTietKThuatCT : FrmBcBase1<ChungTuBanHangGNhanCTietInfor>
...
#region "Các phương thức khởi tạo"
        public frmBC_GiaoNhanChiTietKThuatCT()
        {
            InitializeComponent();
            Common.LoadStyle(this);
            DataProvider = BaoCaoChiTietKyThuatGiaoNhanDataProvider.Instance;
...
#region "Các sự kiên"
        ...
        private void LoadAllTrangThai()
        {
            ...
            List<TrangThaiBH> liTrangThaiDaGN = Common.GetListTrangThaiDaGiaoVan();
            ...
            liTrangThaiDH1.AddRange(liTrangThaiDaGN);
        ...
        {
            if (dteStart.DateTime == DateTime.MinValue)
            {
                dteStart.Focus();
                throw new ManagedException("Bạn chưa chọn từ ngày");
            }
            if(dteEnd.DateTime == DateTime.MinValue)
            {
                dteEnd.Focus();
                throw new ManagedException("Bạn chưa chọn đến ngày");
            }
            if (filter == null)
                filter = new TimKiemGiaoNhanFilterInfor();
        ...
        private void cmdExport_Click(object sender, EventArgs e)
        {
            ...
            Common.Export2ExcelFromDevGrid<ChungTuBanHangGNhanCTietInfor>(gvListChungTu, "BCGNhanKThuatChiTiet");
        }
