...
{
    public partial class frmBC_TongHopDoanhThu : DevExpress.XtraEditors.XtraForm
    {
...
#region "Các sự kiên"
        ...
        private void btnTim_Click(object sender, EventArgs e)
        {
            ...
            {
                EventLogProvider.Instance.WriteOfflineLog(ex.ToString(), "Báo cáo tổng hợp doanh thu.");
#if (DEBUG)
