...
{
    public class frmBH_ListDonHangBan : frmBH_ListChungTuBase
    {
        #region Declaration
        ...
        #region Constructor
        public frmBH_ListDonHangBan()
        {
            Common.LoadStyle(this);
        }
        public frmBH_ListDonHangBan(bool xuatBuKhuyenMai)
        {
            Common.LoadStyle(this);            
        ...
        protected override bool GetFromAction()
        {
            if (XuatBuKhuyenMai)
                ...
                return Common.GetFormStatus("frmBH_LapDonHangBan");
        }
