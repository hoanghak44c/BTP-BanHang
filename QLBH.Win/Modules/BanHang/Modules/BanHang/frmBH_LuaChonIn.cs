...
{
    public partial class frmBH_LuaChonIn : frmBCBase
    {
        Utils ut = new Utils();
        ...
        public frmBH_LuaChonIn()
        {
            InitializeComponent();
            Common.LoadStyle(this);
        }

        public frmBH_LuaChonIn(PhieuXuat px, List<HoaDon> listCT, int phieuthu)
        {
            InitializeComponent();
            this.phieuXuat = px;
        ...
        public frmBH_LuaChonIn(PhieuXuat px, List<HoaDon> listCT)
        {
            InitializeComponent();
            this.phieuXuat = px;
            this.ListChungTu = listCT;
        ...
        public frmBH_LuaChonIn(List<HoaDon> listCT, int phieuthu)
        {
            InitializeComponent();
            this.phieuXuat = null;
            this.ListChungTu = listCT;
        ...
        protected override void OnSetParameterFields(ParameterFields myParams)
        {
            ...
            switch (base.Key) {
                ...
                default:
                    HoaDon hoadon = ListChungTu[Common.IntValue(base.Key.Substring(base.Key.LastIndexOf(" ")))];
