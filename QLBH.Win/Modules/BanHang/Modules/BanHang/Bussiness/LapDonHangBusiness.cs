...
{
    public class LapDonHangBusiness : ChungTuXuatKeToanBusinessBase<ChungTuBanHangInfor, ChungTuBanHangChiTietInfor>
    {
        /// <summary>
        ...
        public LapDonHangBusiness(int loaiChungTu, int idNhanVien, int idKho)
        {
            ChungTu = new ChungTuBanHangInfor
            {
        ...
        public LapDonHangBusiness(ChungTuBanHangInfor chungTuBanHangInfor)
